...
export function registerKeysRoute(app: FastifyInstance): void {
  app.post<{ Body: { label?: string } }>('/api/keys', { schema: CreateApiKeySchema }, async (request: CreateApiKeyRouteRequest, reply: CreateApiKeyRouteReply) => {
